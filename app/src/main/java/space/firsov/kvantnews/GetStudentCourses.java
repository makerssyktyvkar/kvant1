...
class GetStudentCourses extends AsyncTask<String, Void, String> {
    private String login;
    private CoursesOfUserDB coursesOfUserDB;

    GetStudentCourses(String login, Context context) {
        this.login = login;
    ...
    protected String doInBackground(String... args) {
        try {
            String url = "https://kvantfp.000webhostapp.com/ReturnCoursesForStudent.php?login=" + login;
